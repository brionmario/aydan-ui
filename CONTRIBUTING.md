# Contributing to `aydan-ui`

I would love for you to contribute to `aydan-ui` and help make it even better than it is today!
...
```shell
git clone https://github.com/<github username>/aydan-ui.git
```

3. Set the original repo as the upstream remote.

```shell
git remote add upstream https://github.com/brionmario/aydan-ui.git
```
